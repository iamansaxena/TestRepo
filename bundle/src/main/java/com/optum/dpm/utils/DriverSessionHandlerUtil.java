...
public class DriverSessionHandlerUtil {
	...
	private static void setDriverWaits(WebDriver mydriver) {
		...
		mydriver.manage().timeouts().setScriptTimeout(20, TimeUnit.SECONDS);// Changed to 20 from 120/150000 Timeout Debug
		mydriver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS); // Changed to 20 from 120/150000 Timeout Debug
	}
