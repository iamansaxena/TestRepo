...
public class MCL_page extends Base {
	private static final Logger logger = LogManager.getLogger(MCL_page.class);
	
	private String author = "Aman Saxena";
	private String tag = "MCL";
	...
	protected List<WebElement> getFiltersUnderCategory(int indexOfFilterCategory) {
	...
	protected void visitMainSearchPage(String url) {
		mydriver.get(url);
