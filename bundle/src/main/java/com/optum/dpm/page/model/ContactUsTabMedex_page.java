...
public class ContactUsTabMedex_page extends Base{
	private static final Logger logger = LogManager.getLogger(ContactUsTabMedex_page.class);
	
	private String author = "Aman Srivastava";
	private String tag = "ContactUsTabMedex";
	...
	protected void inputInvalidData(List<WebElement> formTab,int index ,Logger logger) {
		scrolltillvisibilityMedex(mydriver,formTab.get(index),logger);
	...
	protected void inputValidDataForm1(List<WebElement> formTab,Logger logger) {
		...
		scrolltillvisibilityMedex(mydriver,formTab.get(0),logger);
	...
	protected void inputValidDataForm2(List<WebElement> formTab,Logger logger) {
		...
		scrolltillvisibilityMedex(mydriver,formTab.get(1),logger);
	...
	protected void inputValidDataForm3(List<WebElement> formTab,Logger logger) {
		...
		scrolltillvisibilityMedex(mydriver,formTab.get(2),logger);
	...
	protected void inputValidDataForm4(List<WebElement> formTab,Logger logger) {
		...
		scrolltillvisibilityMedex(mydriver,formTab.get(3),logger);
	...
	protected void inputValidDataForm5(List<WebElement> formTab,Logger logger) {
		...
		scrolltillvisibilityMedex(mydriver,formTab.get(4),logger);
