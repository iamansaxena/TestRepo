...
public class PluV2_page extends Base {
	private static final Logger logger = LogManager.getLogger(PluV2_page.class);
	
	private String author = "Aman Saxena";
	private String tag = "PluV2";
	...
	public void selectRadius(int value) throws NoSuchElementException, StaleElementReferenceException {
