...
public class ContactUsTabMedex_StepDefinition extends ContactUsTabMedex_page {
	...
	public void feedbackFormErrorOnInvalidDataCheck(String url) {
		...
		for (WebElement error : formErrorMessages) {
			getTest().info("Error " + i + " => " + error.getAttribute("innerText") + " '"
					+ verifyElementExists(logger, error, "Feedback Form Error " + i + "'"+i+"'") + "' ");
			hardAssert.assertTrue(verifyElementExists(logger, error, "Feedback Form Error " + i + "'"+i+"'"));
			i++;
		}
	}
	...
	public void careerFormErrorOnInvalidDataCheck(String url) {
		...
		for (WebElement error : formErrorMessages) {
			getTest().info("Error " + i + " => " + error.getAttribute("innerText") + " '"
					+ verifyElementExists(logger, error, "Career Form Error " + i + "") + "'"+i+"'");
			hardAssert.assertTrue(verifyElementExists(logger, error, "Career Form Error " + i + "'"+i+"'"));
			i++;
		}
	}
	...
	public void employerFormErrorOnInvalidDataCheck(String url) {
		...
		for (WebElement error : formErrorMessages) {
			getTest().info("Error " + i + " => " + error.getAttribute("innerText") + " '"
					+ verifyElementExists(logger, error, "Employer Form Error " + i + "'"+i+"'") + "' ");
			hardAssert.assertTrue(verifyElementExists(logger, error, "Employer Form Error " + i + "'"+i+"'"));
			i++;
		}
	}
	...
	public void billingFormErrorOnInvalidDataCheck(String url) {
		...
		for (WebElement error : formErrorMessages) {
			getTest().info("Error " + i + " => " + error.getAttribute("innerText") + " '"
					+ verifyElementExists(logger, error, "Billing Form Error " + i + "'"+i+"'") + "' ");
			hardAssert.assertTrue(verifyElementExists(logger, error, "Billing Form Error " + i + "'"+i+"'"));
			i++;
		}
	}
	...
	public void generalEnquiryFormErrorOnInvalidDataCheck(String url) {
		...
		for (WebElement error : formErrorMessages) {
			getTest().info("Error " + i + " => " + error.getAttribute("innerText") + " '"
					+ verifyElementExists(logger, error, "General Enquiry Form Error " + i + "'"+i+"'") + "' ");
			hardAssert.assertTrue(verifyElementExists(logger, error, "General Enquiry Form Error " + i + "'"+i+"'"));
			i++;
		}
	}
