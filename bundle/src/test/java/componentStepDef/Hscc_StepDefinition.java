	...
	public void setup() {
		...
		mydriver.manage().timeouts().pageLoadTimeout(120, TimeUnit.SECONDS);if (fetchUrl("hsa-calc") == null) {
			if (Environment.equalsIgnoreCase("stage")) {
				urls.add("http://apsrs5642:8080/content/AutomationDirectory/hscc-calculator.html");
			} else if (Environment.equalsIgnoreCase("test")) {
				urls.add("http://apvrt31468:4503/content/AutomationDirectory/hscc-calculator.html");
			}
		} else {
			String[] scannedUrls = fetchUrl("hsa-calc").split(",");
		...
		setTagForTestClass("HSA Calculator", author, currentDomain, Hscc_StepDefinition.class.getName());
