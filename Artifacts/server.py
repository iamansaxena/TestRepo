...
class SimpleHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        f.write(b"<hr><small>Powered By: Aman Saxena<br>")
    ...
    def deal_post_data(self):
        ...
        while remainbytes > 0:
            ...
            try:
                ...
                return (False, "<br><br>Either you haven't selected any file <br>or <br>you don't have permissions to upload.")
            else:
                with out:                    
    ...
    def list_directory(self, path):
        ...
        f.write(("<title>Artifact Server for Automation %s</title>\n" % displaypath).encode(enc))
        f.write(b'<style type="text/css">\n')
        f.write(b'* {font-family: Helvetica; font-size: 16px; }\n')
        f.write(b'a { text-decoration: none; }\n')
        ...
        for name in list:
            ...
            created_date = time.ctime(os.path.getmtime(fullname))
...
with socketserver.TCPServer(('127.7.7.7', PORT), Handler) as httpd:
